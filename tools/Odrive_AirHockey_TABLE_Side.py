...
acceleration = 1000000/1# (counts/seconds^2) for the trajectory control
deceleration = 1000000/1   # (counts/seconds^2) for the trajectory control
speed = 600000/1
...
#while True:
for i in range(2):
    my_drive.axis0.controller.move_to_pos(-3000)
    my_drive.axis1.controller.move_to_pos(3000)
    #time.sleep(0.5)
    for i in range(150):
        milliseconds = int(round(time.time()*1000)) - start_time
