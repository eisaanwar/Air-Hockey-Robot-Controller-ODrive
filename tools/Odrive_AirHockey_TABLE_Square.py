...
acceleration = 1000000/1.2# (counts/seconds^2) for the trajectory control
deceleration = 1000000/1.2   # (counts/seconds^2) for the trajectory control
speed = 600000/1
...
my_drive.axis0.controller.move_to_pos(-4000)
my_drive.axis1.controller.move_to_pos(-4000)
...
#while True:
for i in range(1):
    my_drive.axis0.controller.move_to_pos(-8000) # -4000
    my_drive.axis1.controller.move_to_pos(0000) # +4000
    #time.sleep(0.5)
    for i in range(150):
        milliseconds = int(round(time.time()*1000)) - start_time
        print(str(milliseconds) +" , " + str(my_drive.axis0.encoder.pos_estimate*(360/4000)) + " , " + str(my_drive.axis1.encoder.pos_estimate*(360/4000)))
        #print("M1 POS, " + str(my_drive.axis1.encoder.pos_estimate))
        time.sleep(0.005)


    my_drive.axis0.controller.move_to_pos(-4000) # +4000
    my_drive.axis1.controller.move_to_pos(-4000) # -4000
    time.sleep(0.5)
    for i in range(150):
        milliseconds = int(round(time.time()*1000)) - start_time
        print(str(milliseconds) +" , " + str(my_drive.axis0.encoder.pos_estimate*(360/4000)) + " , " + str(my_drive.axis1.encoder.pos_estimate*(360/4000)))
