...
my_drive.axis0.motor.config.current_lim = 100
my_drive.axis1.motor.config.current_lim = 100

my_drive.axis0.encoder.config.cpr = 4000
my_drive.axis1.encoder.config.cpr = 4000

my_drive.axis0.controller.config.vel_limit = 25000 # set speeds
my_drive.axis1.controller.config.vel_limit = 25000
...
#while True:
for i in range(1000):
    setpoint = 10000.0 * math.sin((time.monotonic() - t0)*3)
